...
public class RestaurantApplication extends Base {
    ...
    private List<RestaurantApplicationHours> hours = new ArrayList<>();

    @OneToMany(mappedBy = "application", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<RestaurantApplicationImage> images = new ArrayList<>();

    @OneToMany(mappedBy = "application", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<RestaurantApplicationDocument> documents = new ArrayList<>();

    @OneToMany(mappedBy = "application")
    private List<RestaurantVerificationStatusHistory> statusHistory = new ArrayList<>();
}
