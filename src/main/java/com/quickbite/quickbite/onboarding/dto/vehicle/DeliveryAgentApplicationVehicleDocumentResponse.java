...
public record DeliveryAgentApplicationVehicleDocumentResponse(
        UUID id,
        VehicleOwnershipDocumentType type,
        String url
) {
    public static DeliveryAgentApplicationVehicleDocumentResponse from(VehicleApplicationDocument doc) {
        return new DeliveryAgentApplicationVehicleDocumentResponse(
                doc.getId(),
                doc.getType(),
                doc.getUrl()
        );
