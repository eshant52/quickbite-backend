...
import com.quickbite.quickbite.dtos.auth.MaxSessionResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MaxSessionResponse> handleMaxSessionException(MaxSessionException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(new MaxSessionResponse(
