...
ALTER TABLE payments
    ADD CONSTRAINT uc_payments_transaction_id UNIQUE (transaction_id);
...
ALTER TABLE cuisines
    ADD CONSTRAINT FK_CUISINES_ON_REVIEWED_BY FOREIGN KEY (reviewed_by_id) REFERENCES users (id);

ALTER TABLE delivery_agents
    ADD CONSTRAINT FK_DELIVERY_AGENTS_ON_CURRENT_VEHICLE FOREIGN KEY (current_vehicle_id) REFERENCES vehicles (id);

ALTER TABLE delivery_agents
    ADD CONSTRAINT FK_DELIVERY_AGENTS_ON_USER FOREIGN KEY (user_id) REFERENCES users (id);

ALTER TABLE delivery_agent_documents
    ADD CONSTRAINT FK_DELIVERY_AGENT_DOCUMENTS_ON_DELIVERY_AGENT FOREIGN KEY (delivery_agent_id) REFERENCES delivery_agents (id);

ALTER TABLE delivery_agent_documents
    ADD CONSTRAINT FK_DELIVERY_AGENT_DOCUMENTS_ON_REVIEWED_BY FOREIGN KEY (reviewed_by_id) REFERENCES users (id);

ALTER TABLE delivery_agent_verification_history
    ADD CONSTRAINT FK_DELIVERY_AGENT_VERIFICATION_HISTORY_ON_DELIVERY_AGENT FOREIGN KEY (delivery_agent_id) REFERENCES delivery_agents (id);

ALTER TABLE delivery_agent_verification_history
    ADD CONSTRAINT FK_DELIVERY_AGENT_VERIFICATION_HISTORY_ON_REVIEWED_BY FOREIGN KEY (reviewed_by_id) REFERENCES users (id);
...
ALTER TABLE orders
    ADD CONSTRAINT FK_ORDERS_ON_DELIVERY_AGENT FOREIGN KEY (delivery_agent_id) REFERENCES delivery_agents (id);
...
ALTER TABLE restaurant_documents
    ADD CONSTRAINT FK_RESTAURANT_DOCUMENTS_ON_REVIEWED_BY FOREIGN KEY (reviewed_by_id) REFERENCES users (id);
...
ALTER TABLE restaurant_verification_status_history
    ADD CONSTRAINT FK_RESTAURANT_VERIFICATION_STATUS_HISTORY_ON_REVIEWED_BY FOREIGN KEY (reviewed_by_id) REFERENCES users (id);
...
ALTER TABLE vehicle_ownership_documents
    ADD CONSTRAINT FK_VEHICLE_OWNERSHIP_DOCUMENTS_ON_REVIEWED_BY FOREIGN KEY (reviewed_by_id) REFERENCES users (id);

ALTER TABLE vehicle_ownership_documents
    ADD CONSTRAINT FK_VEHICLE_OWNERSHIP_DOCUMENTS_ON_VEHICLE_OWNERSHIP FOREIGN KEY (vehicle_ownership_id) REFERENCES vehicle_ownerships (id);

ALTER TABLE vehicle_ownership_status_history
    ADD CONSTRAINT FK_VEHICLE_OWNERSHIP_STATUS_HISTORY_ON_REVIEWED_BY FOREIGN KEY (reviewed_by_id) REFERENCES users (id);

ALTER TABLE vehicle_ownership_status_history
    ADD CONSTRAINT FK_VEHICLE_OWNERSHIP_STATUS_HISTORY_ON_VEHICLE_OWNERSHIP FOREIGN KEY (vehicle_ownership_id) REFERENCES vehicle_ownerships (id);
